...
class PedestrianDataset(Dataset):
    ...
    def order_timestamp_paths(self, paths):
        ordered_detections = []
        for path in paths:
    ...
    def create_samples(self, detections):
        samples = dict()
