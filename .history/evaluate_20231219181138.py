...
class RunConfig: # class for storing configuration of the run
    sequence_length = 20
...
def rel_to_abs(rel_traj, start_pos): # convert relative trajectory to absolute trajectory
...
def load_datasets(): # load datasets
    datasets = []
    datasets_size = 0
...
def parse_commandline(): # parse command line
